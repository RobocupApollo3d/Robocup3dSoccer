...
#include "../skillsUT/skillparser.h"
    ...
    rsg( rsg_ )
{
    ...
    try {
        readSkillsFromFile( "./skillsUT/stand.skl" );
        readSkillsFromFile( "./skillsUT/kick.skl" );

        // ik skills
        readSkillsFromFile( "./skillsUT/kick_ik_0.skl" );
        // end ik skills
...
//           if ( me.getDistanceTo( VecPosition( -HALF_FIELD_X , 0,0))  < 1 ) {
// // 	if (!oneTimeTest ){
// 		 //oneTimeTest = true;
