...
"$BINARY_DIR/$AGENT_BINARY" $opt --unum 2 --type 3 --paramsfile paramfiles/defaultParams_t4.txt --pkshooter &#> /dev/null &
#"$BINARY_DIR/$AGENT_BINARY" $opt --unum 2 --type 3 --paramsfile paramfiles/defaultParams_t4.txt --pkshooter > stdoutsh 2> stderrsh &
