...
"$BINARY_DIR/$AGENT_BINARY" $opt --unum 1 --type 3 --paramsfile paramfiles/defaultParams_t4.txt --pkgoalie &#> /dev/null &
#"$BINARY_DIR/$AGENT_BINARY" $opt --unum 1 --type 3 --paramsfile paramfiles/defaultParams_t4.txt --pkgoalie > stdoutgk 2> stderrgk &
